...
public class GroupJoinDao {
   ...
   public boolean joinGroup(String member_id, int group_num, String blog_mail, String member_name, String member_hp, String member_zipcode, String member_address, String member_address_detail, String member_address_etc) {
	   boolean check = false;
