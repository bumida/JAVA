...
${session_id}
 ...
 <form action="${pageContext.request.contextPath}/group/GroupJoin.gr?group_num=${g_bean.getGroup_num()}" method="post" >
                        ...
                        <div class="register-form text-center">
                            ...
                            <div class="input-box" >
                                <div class="single-input-fields" >
                                    <label>아이디</label>
                                    <input style="text-transform:lowercase";  type="text"  name="member_id" value="${session_id}" placeholder="${session_id}" disabled/>
                                    <p id="idCheck_text"></p>
                                </div>
                                <div class="single-input-fields">
                                    <label>블로그메일</label>
                                ...
                                <div class="single-input-fields">
                                    <label>참고항목</label>
                                    <input style="text-transform:lowercase"; type="text" name="member_address_etc" class="postcodify_extra_info" placeholder="이메일을 입력해주세요"/>
                                </div>
                            </div>
                            <!-- form Footer -->
