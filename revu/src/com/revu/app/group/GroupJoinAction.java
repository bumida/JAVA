...
//		
		...
		boolean j_check = j_dao.joinGroup(group_num, group_name, member_id, blog_mail, member_name, member_hp, member_zipcode, member_address, member_address_detail, member_address_etc);
