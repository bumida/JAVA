...
public class GroupRegisterAction implements Action{
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		g_bean.setGroup_register_date(multi.getParameter("group_register_date"));
		g_bean.setGroup_review_date(multi.getParameter("group_review_date"));
		g_bean.setGroup_reviewer_date(multi.getParameter("group_reviewer_date"));
