                        ...
                        <div class="single-baner-nw2 mb-30">
                            <div class="banner-img-cap2">
                                <div class="banner-img">
                                 <a href="${pageContext.request.contextPath}/group/Groupview.gr?group_num=${h_bean.getGroup_num()}">   <img src="${pageContext.request.contextPath}/${h_bean.getGroup_img()}" alt="" width="350" height="250"></a>
                                </div>
